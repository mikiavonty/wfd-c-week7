...
<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __($job->title.' Application') }}
        </h2>
    </x-slot>

    <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        <form method="POST" enctype="multipart/form-data"
            action="{{ route('jobapplications.store', ['joblisting' => $job->id]) }}">
            @csrf
            ...
            <div class="space-y-12">
                <div class="border-b border-gray-900/10 pb-12">
                    ...
                    <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        ...
                        <div class="col-span-full">
                            <label for="cover_letter" class="block text-sm/6 font-medium text-gray-900">Cover
                                Letter</label>
                            <div class="mt-2">
                            ...
                            <p class="mt-3 text-sm/6 text-gray-600">Highlight your key qualifications and interests in
                                this
                                position.</p>
                            @error('cover_letter')
                                <div class="text-sm text-red-700">{{ $message }}</div>
